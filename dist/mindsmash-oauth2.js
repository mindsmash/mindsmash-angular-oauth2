...
(function() {
	...
	angular.module('mindsmash.oauth2', ['rails', 'angular-jwt'])
...
(function() {
	 ...
	 */
	.factory('mindsmashOauth2Interceptor', ['$injector', '$q', function($injector, $q) {
		return {
			request: function(config) {
				...
				if(authService.getAccessToken() !== null && (config.headers.Authorization === undefined || config.headers.Authorization.indexOf('Bearer') !== -1)) {
